...
from solathon_aiohttp.core.message import Message as CoreMessage
from solathon_aiohttp.core.message import MessageHeader
...
class Header:
    def __init__(self, response: HeaderType) -> None:
        self.num_readonly_signed_accounts = response[
            "numReadonlySignedAccounts"
        ]
        self.num_readonly_unsigned_accounts = response[
...
class TransactionElement:
    ...
    def __repr__(self) -> str:
        return (
            f"TransactionElement(signatures={self.transaction.signatures!r})"
        )
