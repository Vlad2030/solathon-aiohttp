...
class Message:
    ...
    def encode_message(self) -> bytes:
        ...
        return b"".join(
            MessageFormat(
                ...
                public_keys=b"".join(
                    [bytes(public_key) for public_key in self.account_keys]
                ),
    ...
    def from_buffer(buffer: bytes) -> Message:
        # Reference:
        # https://github.com/solana-labs/solana-web3.js/blob/a1fafee/packages/library-legacy/src/message/legacy.ts#L267
        ...
        return Message(
            ...
            account_keys,
            instructions,
            b58encode(recent_blockhash).decode("utf-8"),
        )
